...
class Config:
    ...
    STORE_PROFILES = {
        'default': {
            ...
            'phone': env('STORE_PHONE', '39917934'),
            'phone_display': env('STORE_PHONE_DISPLAY', env('STORE_PHONE', '39917934')),
            'phone_country_code': env('STORE_PHONE_COUNTRY_CODE', '+973'),
            'email': env('STORE_EMAIL', ''),
            'support_email': env('STORE_SUPPORT_EMAIL', env('STORE_EMAIL', '')),
            'admin_email': env('ADMIN_MAIL', env('STORE_EMAIL', '')),
            'instagram_url': env('STORE_INSTAGRAM_URL', 'https://www.instagram.com/mq.cars/'),
            'instagram_handle': env('STORE_INSTAGRAM_HANDLE', '@mq.cars'),
            'tiktok_url': env('STORE_TIKTOK_URL', ''),
            'whatsapp_url': env('STORE_WHATSAPP_URL', 'https://wa.me/97339917934'),
